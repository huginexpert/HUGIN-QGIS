...
from .hugin_qgis_algorithm import HuginQGISAlgorithm


class HuginQGISProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(HuginQGISAlgorithm())
